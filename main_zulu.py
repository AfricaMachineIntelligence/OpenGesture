...
detection_nn.setBlobPath(str(Path("gesture.blob").resolve().absolute()))
...
with dai.Device(pipeline) as device:
    ...
    class_names = ['isishiyagalombili', 'kuhlanu', 'kune', 'isishiyagalolunye', 'kunye', 'isikhombisa', 'isithupha', 'kuthathu', 'kubili', 'okungekho']
